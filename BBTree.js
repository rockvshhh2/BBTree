                    ...
                    for (var i = 0 ; i < Datas.length ; i++) {
                        ...
                        if (Node.Children) {
                            if (Node.Children.length > 0) {
                                ...
                                NodeChild_Img = img;
                                img.setAttribute("src", "BBTreeImage/Show.png");
                                td.style.width = img.style.width;
                                ...
                                $(img).click(function () {
                                    if (this.Show) {
                                        ...
                                        $(this).attr("src", "BBTreeImage/Hide.png");
                                        if (options.ChildIcon) {
                                        ...
                                        $(this).attr("src", "BBTreeImage/Show.png");
                                        if (options.ChildIcon) {
                                            if (options.ChildIcon.Show) {
                                                img.setAttribute("src", options.ChildIcon.Show);
                                            }
                                ...
                                if (Node.HideChildrenNode) {
                                    ...
                                    if (NodeChild_Img) {
                                        NodeChild_Img.setAttribute("src", "BBTreeImage/Hide.png");
